		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFourthLevelExpAccess().getAlternatives_1_0(), "rule__FourthLevelExp__Alternatives_1_0");
					...
					put(grammarAccess.getFourthLevelExpAccess().getFirstAssignment_0(), "rule__FourthLevelExp__FirstAssignment_0");
					put(grammarAccess.getFourthLevelExpAccess().getSecondAssignment_1_1(), "rule__FourthLevelExp__SecondAssignment_1_1");
